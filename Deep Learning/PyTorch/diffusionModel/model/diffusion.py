...
class UNET_AttentionBlock(nn.Module):
    def __init__(self, n_head:int, n_embd:int, d_context:int=768):
        ...
        self.groupnorm = nn.GroupNorm(32, n_embd)
    ...
    def forward(self, x, context: torch.Tensor) -> torch.Tensor:
...
class UNET(nn.Module):
    def __init__(self):
        ...
        self.encodes = nn.Module([
            ...
            # (batch_size, 1280, height / 64, width / 64) -> (batch_size, 1280, height / 32, width / 32)
            SwitchSequential(UNET_ResidualBlock(1280, 1280)),
        ])
        ...
        self.decoders = nn.ModuleList([
            ...
            SwitchSequential(UNET_ResidualBlock(960, 1280), UNET_AttentionBlock(8, 80), Upsample(640)),
...
class Diffusion(nn.Module):
    def __init__(self):
        ...
        self.unet = UNET()
        self.final = UNET_OutputLayer(324, 4)
